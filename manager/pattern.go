...
// PatternA3BigRoad
// 當莊閒連續出現4次，就不再下注
func (analyzeManager *AnalyzeManager) PatternA3BigRoad(bigRoad *roadmap.BigRoad, prediction *Prediction) {
	analyzeManager.PatternAInBigRoad(bigRoad, prediction)
}

func (analyzeManager *AnalyzeManager) PatternA3BigEyeRoad(bigEyeRoad *roadmap.BigEyeRoad, prediction *Prediction) {
	analyzeManager.PatternAInBigEyeRoad(bigEyeRoad, prediction)
}

func (analyzeManager *AnalyzeManager) PatternA3SmallRoad(smallRoad *roadmap.SmallRoad, prediction *Prediction) {
	analyzeManager.PatternAInSmallRoad(smallRoad, prediction)
}

func (analyzeManager *AnalyzeManager) PatternA3CockroachRoad(cockroachRoad *roadmap.CockroachRoad, prediction *Prediction) {
	analyzeManager.PatternAInCockroachRoad(cockroachRoad, prediction)
}

// PatternB3BigRoad
// 當莊閒連續出現4次，就不再下注
func (analyzeManager *AnalyzeManager) PatternB3BigRoad(bigRoad *roadmap.BigRoad, prediction *Prediction) {
	analyzeManager.PatternBInBigRoad(bigRoad, prediction)
}

func (analyzeManager *AnalyzeManager) PatternB3BigEyeRoad(bigEyeRoad *roadmap.BigEyeRoad, prediction *Prediction) {
	analyzeManager.PatternBInBigEyeRoad(bigEyeRoad, prediction)
}

func (analyzeManager *AnalyzeManager) PatternB3SmallRoad(smallRoad *roadmap.SmallRoad, prediction *Prediction) {
	analyzeManager.PatternBInSmallRoad(smallRoad, prediction)
}

func (analyzeManager *AnalyzeManager) PatternB3CockroachRoad(cockroachRoad *roadmap.CockroachRoad, prediction *Prediction) {
	analyzeManager.PatternBInCockroachRoad(cockroachRoad, prediction)
}

// PatternA5BigRoad
// 當莊閒連續出現四次，就打相反
func (analyzeManager *AnalyzeManager) PatternA5BigRoad(bigRoad *roadmap.BigRoad, prediction *Prediction) {
	analyzeManager.PatternAInBigRoad(bigRoad, prediction)
}

func (analyzeManager *AnalyzeManager) PatternA5BigEyeRoad(bigEyeRoad *roadmap.BigEyeRoad, prediction *Prediction) {
	analyzeManager.PatternAInBigEyeRoad(bigEyeRoad, prediction)
}

func (analyzeManager *AnalyzeManager) PatternA5SmallRoad(smallRoad *roadmap.SmallRoad, prediction *Prediction) {
	analyzeManager.PatternAInSmallRoad(smallRoad, prediction)
}

func (analyzeManager *AnalyzeManager) PatternA5CockroachRoad(cockroachRoad *roadmap.CockroachRoad, prediction *Prediction) {
	analyzeManager.PatternAInCockroachRoad(cockroachRoad, prediction)
}

// PatternB5BigRoad
// 當莊閒連續出現四次，就打相反
func (analyzeManager *AnalyzeManager) PatternB5BigRoad(bigRoad *roadmap.BigRoad, prediction *Prediction) {
	analyzeManager.PatternBInBigRoad(bigRoad, prediction)
}

func (analyzeManager *AnalyzeManager) PatternB5BigEyeRoad(bigEyeRoad *roadmap.BigEyeRoad, prediction *Prediction) {
	analyzeManager.PatternBInBigEyeRoad(bigEyeRoad, prediction)
}

func (analyzeManager *AnalyzeManager) PatternB5SmallRoad(smallRoad *roadmap.SmallRoad, prediction *Prediction) {
	analyzeManager.PatternBInSmallRoad(smallRoad, prediction)
}

func (analyzeManager *AnalyzeManager) PatternB5CockroachRoad(cockroachRoad *roadmap.CockroachRoad, prediction *Prediction) {
	analyzeManager.PatternBInCockroachRoad(cockroachRoad, prediction)
}
