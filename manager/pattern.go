...
func (analyzeManager *AnalyzeManager) PatternB3BigRoad(bigRoad *roadmap.BigRoad, prediction *Prediction) {
	...
	for colIndex := 2; colIndex < len(bigRoad.Columns); colIndex++ {
		...
		if colIndex >= 2 && len(bigRoad.Columns[colIndex].Blocks) >= 4 {
			return
		}
	}
	lastColumn := bigRoad.Columns[len(bigRoad.Columns)-1]
...
func (analyzeManager *AnalyzeManager) PatternB3BigEyeRoad(bigEyeRoad *roadmap.BigEyeRoad, prediction *Prediction) {
	...
	for colIndex := 2; colIndex < len(bigEyeRoad.Columns); colIndex++ {
		...
		if colIndex >= 2 && len(bigEyeRoad.Columns[colIndex].Blocks) >= 4 {
			return
		}
	}
	lastColumn := bigEyeRoad.Columns[len(bigEyeRoad.Columns)-1]
...
func (analyzeManager *AnalyzeManager) PatternB3SmallRoad(smallRoad *roadmap.SmallRoad, prediction *Prediction) {
	...
	for colIndex := 2; colIndex < len(smallRoad.Columns); colIndex++ {
		...
		if colIndex >= 2 && len(smallRoad.Columns[colIndex].Blocks) >= 4 {
			return
		}
	}
	lastColumn := smallRoad.Columns[len(smallRoad.Columns)-1]
...
func (analyzeManager *AnalyzeManager) PatternB3CockroachRoad(cockroachRoad *roadmap.CockroachRoad, prediction *Prediction) {
	...
	for colIndex := 2; colIndex < len(cockroachRoad.Columns); colIndex++ {
		...
		if colIndex >= 2 && len(cockroachRoad.Columns[colIndex].Blocks) >= 4 {
			return
		}
	}
	lastColumn := cockroachRoad.Columns[len(cockroachRoad.Columns)-1]
